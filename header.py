...
STRING_FEATURES = [AIRLINE_ID, ORIGIN_AIRPORT_ID, DEST_AIRPORT_ID, ORIGIN_CITY_MARKET_ID, DEST_CITY_MARKET_ID]

ALL_FEATURES = []
ALL_FEATURES += INT_FEATURES
ALL_FEATURES += FLOAT_FEATURES
ALL_FEATURES += STRING_FEATURES
